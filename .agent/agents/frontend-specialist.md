...
model: inherit
skills: clean-code, react-best-practices, web-design-guidelines, tailwind-patterns, frontend-design, lint-and-validate, taste-skill, brandkit, minimalist-skill, soft-skill, redesign-skill
---
